...
@Component({
  ...
  animations: [
    ...
    trigger('scaleLogo', [
      state('upscaled', style({ marginTop: '59.97vh', transform: 'scale3d(3.0, 3.0, 3.0) translateZ(0)' })),
      state('normal', style({ marginTop: '0', transform: 'scale3d(1.0, 1.0, 3.0) translateZ(0)' })),
